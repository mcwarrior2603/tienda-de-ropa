...
import Interfaz.VentanaApartado;
...
public class Venta extends javax.swing.JDialog {        
            ...
            if(consulta.next()){
                ...
                btnEliminar.setEnabled(
                        !(consulta.getBoolean("CANCELADO") ||
                                consulta.getString("FORMA_PAGO").equalsIgnoreCase("APARTADO")));
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(75, 23));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if(txtFormaDePago.getText().equalsIgnoreCase("Efectivo")){
            try {
                String sql = "SELECT FOLIO_INGRESO FROM PAGOS_DE_CONTADO WHERE FOLIO_VENTA=" + folioVenta;
                ResultSet consulta = SQLConnection.select(sql);
                ...
                if(Ingreso.eliminar(folioIngreso)){
                    String cancelarVenta = "UPDATE VENTAS CANCELADO=TRUE WHERE FOLIO=" + folioVenta;
                    
                    if(SQLConnection.update(cancelarVenta)){
